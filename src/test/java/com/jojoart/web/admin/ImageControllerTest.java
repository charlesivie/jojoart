...
public class ImageControllerTest {
    ...
    public void get_edit_should_load_image_versions() {
        ...
        ImageVersion imageVersion = new ImageVersion("whatever".getBytes(), ImageType.NORMAL.toString(), image);
        ImageVersion imageVersion2 = new ImageVersion("whatever".getBytes(), ImageType.THUMBNAIL.toString(), image);
